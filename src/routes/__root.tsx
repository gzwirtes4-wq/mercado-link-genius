...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mercado Ecommerce | Ferramentas para afiliados do Mercado Livre" },
      {
        name: "description",
        content:
          "Encontre produtos, organize suas divulgações e acompanhe resultados como afiliado do Mercado Livre.",
      },
